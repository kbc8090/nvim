...
bind('n', '<leader>n', '<CMD>Neotree toggle position=left<CR>', { desc = "NeoTreeToggle Left Pane" })
bind('n', '<leader>N', '<CMD>Neotree toggle position=float<CR>', { desc = "NeoTreeToggle Floating" })
bind('n', '<TAB>', '<CMD>BufferLineCycleNext<CR>', { desc = "Next Buffer" })
bind('n', '<leader>C', '<cmd>Telescope colorscheme<cr>', { desc = "Telescope Colorscheme Switching" })
